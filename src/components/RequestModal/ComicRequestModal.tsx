  ...
  return (
    ...
    >
      <Modal
        ...
        okDisabled={
          isSubmitting || (selectable.length > 0 && selectedIssues.length === 0)
        }
      ...
      >
        ...
        {selectable.length > 0 ? (
                    ...
                    <tbody className="divide-y divide-gray-700">
                      {(issues ?? [])
                        .filter(
                          (
                            i
                          ): i is ComicIssueOption & { issueNumber: string } =>
                            !!i.issueNumber
                        )
                        .map((i) => {
          ...
          <div className="mt-6">
            <Alert title={intl.formatMessage(messages.noIssues)} type="info" />
          </div>
        )}

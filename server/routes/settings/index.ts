...
import livrarrRoutes from './livrarr';
import mangaSettingsRoutes from './mangaSettings';
import pressarrRoutes from './pressarr';
import mediaTypeSettingsRoutes from './mediaTypeSettings';
...
settingsRoutes.use('/livrarr', livrarrRoutes);
settingsRoutes.use('/pressarr', pressarrRoutes);
...
settingsRoutes.use('/audiobook', audiobookSettingsRoutes);
settingsRoutes.use('/manga', mangaSettingsRoutes);
settingsRoutes.use('/comic', comicSettingsRoutes);
settingsRoutes.use('/media-types', mediaTypeSettingsRoutes);
settingsRoutes.use('/request-notices', requestNoticesRoutes);
settingsRoutes.use('/notices', noticesRoutes);
